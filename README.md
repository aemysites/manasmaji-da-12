...
## Environments
- Preview: https://main--manasmaji-da-12--aemysites.aem.page/
- Live: https://main--manasmaji-da-12--aemysites.aem.live/
...
1. Open the `manasmaji-da-12` directory in your favorite IDE and start coding :)
